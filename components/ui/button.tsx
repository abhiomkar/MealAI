...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-full text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-spinach text-neutral-50 hover:bg-spinach-800 rounded-full dark:bg-spinach-200 dark:text-neutral-900 dark:hover:bg-spinach-100",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-transparent text-spinach-800 hover:bg-spinach-100/20 hover:border-spinach-800 dark:text-spinach-100",
        secondary:
